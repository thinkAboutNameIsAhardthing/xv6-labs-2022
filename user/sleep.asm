...
main(int argc, char *argv[])
{
  ...
  1c:	344080e7          	jalr	836(ra) # 35c <sleep>
  exit(0);
  20:	4501                	li	a0,0
  ...
  2e:	7c658593          	addi	a1,a1,1990 # 7f0 <malloc+0xf2>
  32:	4509                	li	a0,2
  34:	00000097          	auipc	ra,0x0
  38:	5e4080e7          	jalr	1508(ra) # 618 <fprintf>
    exit(1);
  3c:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b4:	4b850513          	addi	a0,a0,1208 # 868 <digits>
 3b8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 474:	3a0c8c93          	addi	s9,s9,928 # 810 <malloc+0x112>
 ...
 482:	3eab8b93          	addi	s7,s7,1002 # 868 <digits>
 ...
 5a8:	26498993          	addi	s3,s3,612 # 808 <malloc+0x10a>
        while(*s != 0){
 5ac:	85ee                	mv	a1,s11
